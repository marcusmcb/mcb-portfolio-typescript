        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.bodyContainer}>
            ...
            >
              ...
              opportunites that don’t fit that description. I’m a <br className={styles.break}></br>{" "}
              hard-working and positive person who will always approach each task with a sense of
              purpose and attention to detail. Please do feel free to check out my online profiles
